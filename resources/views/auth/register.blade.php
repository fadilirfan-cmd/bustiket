...
<body class="bg-black">
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-red-900">
        <div class="bg-gray-900 p-8 rounded-lg shadow-2xl w-full max-w-md border border-red-800">
            ...
            {{-- Alert Messages --}}
            @if (session('success'))
                <div class="bg-green-900 border border-green-700 text-green-100 px-4 py-3 rounded mb-4 text-sm">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            id="name" 
                            value="{{ old('name') }}"
                            class="bg-gray-800 border border-gray-700 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full pl-10 pr-3 py-3 @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        <select 
                            name="role" 
                            id="role" 
                            class="bg-gray-800 border border-gray-700 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-3 @error('role') border-red-500 @enderror"
                            required
                        >
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-400">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="font-medium text-red-400 hover:text-red-300">
                            Login di sini
                        </a>
                    </p>
                </div>
