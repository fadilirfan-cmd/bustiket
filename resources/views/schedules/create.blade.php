...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Create New Schedule</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="time" name="departure_time" id="departure_time" 
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('departure_time') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="total_seats" id="total_seats" min="1"
                               value="{{ old('total_seats', 40) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="available_seats" id="available_seats" min="0"
                               value="{{ old('available_seats', 40) }}" required
